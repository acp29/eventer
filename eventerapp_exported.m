  ...
  methods (Access = private)
    ...
    function LoadButtonPushed(app, event)
            ...
            [file.baseName, file.Path] = uigetfile(...
                ...
                '*.dat','HEKA PatchMaster binary files (*.dat)';...
    ...
    function AboutEventerButtonPushed(app, event)
            credits=["\fontname{Helvetica}\fontsize{14}\color{black}\bfEVENTER\rm",...
                   "\fontsize{12}\color{black}v1.5.0",...
                   ...
                   "Winchester, G., Steele, O.G., Liu, S., Maia Chagas, A., Aziz, W. and Penn, A.C. (2024)\rm Reproducible supervised learning-assisted classification of spontaneous synaptic waveforms with Eventer.\rm \itFront. Neuroinform. \rmVolume 18. https://doi.org/10.3389/fninf.2024.1427642","\color{black}",...
                   ...
                   "\bfHEKA\_Patchmaster\_Importer\rm, version 1.1","Copyright © Christian Keine 2019",...
