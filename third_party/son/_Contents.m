...
%   MakeMATFile             - Create MAT-file and write header
%   OpenMATFile             - Open MAT file for use by SON library
%   SONImport               - copies all channels into a MAT-file


%   SONMarkerDisplay        - SONMarkerDisplay is used by sigTOOL and is not part of the stand-alone 
