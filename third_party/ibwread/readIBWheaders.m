function [BH, H, FFN] = readIBWheaders(FFN,pos);
...
switch BH.version
    case 2,
        ...
        fseek(fid,16,'cof'); % start of wave header of IBW vs 2; % struct WaveHeader2 {
...
%        dummy = fread(fid,1, 'uint8'); %  align
    ...
    case 5,
        ...
        %         Wave data: Variable size
        fseek(fid,64,'cof'); % start of wave header of IBW vs 5
        %
