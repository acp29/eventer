        ...
        function o = LinePlotExplorer(varargin)
            ...
            function HelpInfo(src,event)
                ...
                msg = { ...
                       ...
                       '\bfDrag  in X^{\ast}: \rmLeft  button drag', ...
                       '\bfDrag  in Y : \rmRight button drag \bfOR\rm Left button drag + SHIFT', ...
                       ...
                       '\bfDrag^{\Psi} in X^{\ast}: \rmLEFT/RIGHT CURSOR + ALT (or OPTION)', ...
                       '\bfDrag  in X^{\ast}: \rmLEFT/RIGHT CURSOR', ...
                       '\bfDrag  in Y : \rmUP/DOWN    CURSOR', ...
                       '\bfAutoscale  : \rmESCAPE or RETURN', ...
                       '\fontname{Arial}', ...
                       '^{\Phi} The zoom focus is the center of the current plot view.', ...
                       ' ', ...
                       '^{\ast} Drag and zoom along the X-axis may respect the limits of the data.', ...
                       ' ', ...
                       '^{\Psi} Modifier key (ALT or OPTION) increases step size from 10% to 100%.', ...
                       '\it', ...
            ...
            switch event.Key
                ...
                case 'leftarrow'
                    ...
                    elseif (ismember (event.Modifier,{'alt'})) 
                        ...
                        % Pan (100% window length steps)
                        new_lims = old_lims + diff(old_lims);
